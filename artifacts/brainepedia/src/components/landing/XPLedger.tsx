    ...
    <section className="py-32 bg-card/20 relative" id="ledger">
      <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center gap-16">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-6">The Ledger of Truth.</h2>
          <p className="text-xl text-muted-foreground mb-8">
            Your resume is a list of claims. The VX Ledger is a cryptographic record of proof. Every mission you complete adds to your permanent public profile.
          </p>
          <p className="text-lg text-muted-foreground">
            Recruiters don't have to guess if you know what you're doing. They just check the ledger.
          </p>
        </motion.div>
      </div>
    </section>
